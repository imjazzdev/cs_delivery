...
class AdminPenerimaanDetail extends StatefulWidget {
  final int id;
  final String nama;
  final String telp;
  ...
  @override
  State<AdminPenerimaanDetail> createState() => _AdminPenerimaanDetailState();
}

class _AdminPenerimaanDetailState extends State<AdminPenerimaanDetail> {
